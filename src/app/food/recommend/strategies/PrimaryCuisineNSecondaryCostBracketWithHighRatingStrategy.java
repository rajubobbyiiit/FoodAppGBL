...
public class PrimaryCuisineNSecondaryCostBracketWithHighRatingStrategy implements RecommendStrategy{
	
	private static final float rating = 4.5F;
	
	@Override
	public List<Restaurant> recommendRestaurants(List<Restaurant> restaurants, User user) {
		List<Restaurant> restrnts= RecommendStrategyUtil.filterByCuisineCostHightRating(
				restaurants,user.getPrimaryCuisine(),user.getSecondaryCostBracket1(),rating);
		restrnts.addAll(RecommendStrategyUtil.filterByCuisineCostHightRating(
